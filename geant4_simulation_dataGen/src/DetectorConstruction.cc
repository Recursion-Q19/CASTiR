...
{
	World_VisAtt = new G4VisAttributes(true, G4Colour(0., 0., 0., 0.));
	...
	for(G4int copyNo=0; copyNo<numDetectorsPerRing; copyNo++)
	{  
		//logicDet[copyNo]->SetVisAttributes(G4VisAttributes::Invisible);
	...
	//logicPh->SetVisAttributes(G4VisAttributes::Invisible);
	logicPh->SetVisAttributes(VisAttPhantom);
		
	VisAttfCham = new G4VisAttributes(true, G4Colour(0.0, 1.0, 0., 0.4));
	...
	VisAttColdSubChamOuterPositive = new G4VisAttributes(true, G4Colour(0.0, 0.0, 1.0, 1.0));
	...
	VisAttColdSubChamOuterNegative = new G4VisAttributes(true, G4Colour(1.0, 1.0, 1.0, 1.0));
