...
class DataManager //a singleton class
{
	public:
		...
		//std::map<std::set<unsigned int>, float> histmode;
		std::map<std::set<uint16_t>, uint16_t> histmode;
	...
	public:
		...
		void WriteCASToRheader(unsigned long int num_records, bool norm_flag);
